package in.co.fleshkart.backend;
 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "numberstatus.com", ownerName = "numberstatus.com", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyBOodutW1zRRIqCDZgyrVG0EO6yaFKidrg";
  ...
  public static void sendMessage(@Named("message") String message)
      throws IOException {
